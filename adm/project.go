...
import "github.com/HongJaison/go-admin3/plugins/admin/modules/table"
...
`), 0644))
	...
	fmt.Println()
	fmt.Println("- sqlite: " + ansi.Color("https://github.com/HongJaison/go-admin3/raw/master/data/admin.db", "blue"))
	fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin3/master/data/admin.mssql", "blue"))
	fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin3/master/data/admin.pgsql", "blue"))
	fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/HongJaison/go-admin3/master/data/admin.sql", "blue"))
	fmt.Println()
