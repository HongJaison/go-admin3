...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/gin"                    // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}" // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                       // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/beego"                   // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/buffalo"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/chi"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/echo"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/fasthttp"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/gf"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/gorilla"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/HongJaison/go-admin3/adapter/iris"                 // web framework adapter
	_ "github.com/HongJaison/go-admin3/modules/db/drivers/{{.Driver}}"  // sql driver
	_ "github.com/HongJaison/themes3/{{.Theme}}"                        // ui theme
...
import (
	...
	"github.com/HongJaison/themes3/sword/components/card"
	"github.com/HongJaison/themes3/sword/components/chart_legend"
	"github.com/HongJaison/themes3/sword/components/description"
	"github.com/HongJaison/themes3/sword/components/progress_group"
	"html/template"
)
...
import (
	...
	"github.com/HongJaison/go-admin3/template/types"
	"github.com/HongJaison/themes3/adminlte/components/chart_legend"
	"github.com/HongJaison/themes3/adminlte/components/description"
	"github.com/HongJaison/themes3/adminlte/components/infobox"
...
import (
	"./tables"
	"github.com/HongJaison/go-admin3/modules/config"
	"github.com/HongJaison/go-admin3/tests"
	"github.com/HongJaison/go-admin3/tests/common"
	"github.com/HongJaison/go-admin3/tests/frameworks/gin"
	"github.com/HongJaison/go-admin3/tests/web"
...
- [github](https://github.com/HongJaison/go-admin3)
