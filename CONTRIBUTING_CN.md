...
在这里：[功能规划](https://github.com/HongJaison/go-admin3/projects/3) 可以获得更多信息。
...
然后，你需要fork远程的master分支到你本地 **\$GOPATH**/src/github.com/HongJaison/go-admin3 ：
...
注意了： `go get` 返回 `package github.com/HongJaison/go-admin3: no Go files in /go/src/github.com/HongJaison/go-admin3` 是正常的。
