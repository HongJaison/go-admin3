...
import (
	...
	"github.com/HongJaison/go-admin3/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/HongJaison/go-admin3/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/HongJaison/go-admin3/blob/master/template/login/list.go
	GetAssetList() []string
